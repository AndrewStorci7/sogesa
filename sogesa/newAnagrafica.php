...
<div class="fon-lista fon-listaFull fon-modifica">
    <fieldset class="fon-fieldset">
        ...
        <div class="fon-itemDtl">
            <h4>Box n°</h4>
            <input class="fon-input" type="text" id="fon-boxN">
        </div>
        <div class="fon-itemDtl">
            <h4>GG</h4>
            <input class="fon-input" type="text" id="fon-gg">
        </div>
        <div class="fon-itemDtl">
            <h4>Prezzo giornaliero</h4>
            <input class="fon-input" type="text" id="fon-prezzoGG">
        </div>
    </fieldset>
</div>
</div>
