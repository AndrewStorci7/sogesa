...
?>
	...
	<body>
		...
		<table cellpadding="5" cellspacing="0" border="1">
			...
			<tr>
				<td width="75%" bgcolor="#999"><b>Codice UNIVOCO fatturazione elettronica (OBBLIGATORIO)</b>
					<p>Nel caso in cui non venga comunicato da parte Vostra alcun canale telematico (CODICE UNIVOCO e/o PEC), So.Ge.S.A. S.r.l. utilizzer&agrave; il codice generico (0000000)</p>
				</td>
		...
		<div style="padding:10px 0;">
			<p style="width:28%; display:inline-block;padding:10px 0 0 0;"><b>Affitto Box n&quot; <?php echo $boxN ?></b></p>
			<p style="width:28%; display:inline-block;padding:10px 0 0 0;"><b>gg. <?php echo $gg ?> x &euro; <?php echo $prezzoGG ?></b></p>
			<p style="width:10%; float:right; border:1px solid #000;padding:10px 0;text-align: center;"><b><?php echo $gg * $prezzoGG  ?></b></p>
