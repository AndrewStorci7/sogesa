<script>
	...
	$('.fon-change').bind('keyup', function(event) {
		...
		var cf = '';
		jQuery.post('viewAnagrafica.php', {
			nome: nome,
			cognome: cognome,
			cf: cf,
			pager: 1
